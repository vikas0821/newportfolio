...
function CardBox() {
  ...
  return (
    <div className="card_box">
      <Card  className="card js_box" icon="fa-solid fa-code" title="Javascript" details={d_1} dataAos="fade-right" dataAosDelay="1200" />
      <Card className="card r_box" icon="fa-brands fa-react " title="React" details={d_2} dataAos="fade-up" dataAosDelay="1400"/>
      <Card className="card n_box" icon="fa-brands fa-node-js " title="NodeJs " details={d_3} dataAos="fade-left" dataAosDelay="1600"/>
    </div>
  )
}
